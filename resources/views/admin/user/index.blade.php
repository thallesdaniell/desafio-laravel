        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    <a href="{{ route('admin-user.create') }}" class="btn btn-primary text-right">Criar Usuário</a>
                </div>
                                                ...
                                                <td>
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu animated--fade-in" aria-labelledby="dropdownMenuButton">
                                                            <a class="dropdown-item" href="{{ route('admin-user.edit',$user->id) }}"><i class="fas fa-cog"></i> Editar</a>
                                                            <div class="dropdown-divider"></div>
                                                            <form method="POST" action="{{route('admin-user.destroy',$user->id) }}" id="user_destroy{{ $user->id }}">
                                                                @csrf
                                                                @method('DELETE')
